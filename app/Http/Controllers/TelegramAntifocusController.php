...
class TelegramAntifocusController extends Controller{

    const BOT_TOKEN = '1150856148:AAE9QUTmpV_fryX73NpnsUza964p16towyY';
    ...
    public function postIndex(Request $request){
        ...
        //check only narrador2 bot messages
