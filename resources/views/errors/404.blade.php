...
<html>
    ...
    <body>
        ...
        <div class="explain">
            <h4>{{trans('messages.app.error.404.explain')}}</h4>
            <h6>{!! trans('messages.app.error.404.links', ['buscar'=>'<a href="'.\App\Helper::getPathFor("listado-casas-venta-permuta-cuba").'"><strong>'.trans_choice("messages.actions.seek.property", 2).'</strong></a>',
